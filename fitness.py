...
class WorkoutApp:
    def __init__(self, root):
        ...
        tk.Label(root, text="Enter Name:", font=font_style, bg="#DFF6FF").grid(row=0, column=0)
        self.name_entry = tk.Entry(root, font=font_style)
        self.name_entry.grid(row=0, column=1)
        
        tk.Label(root, text="Enter Age:", font=font_style, bg="#DFF6FF").grid(row=1, column=0)
        self.age_entry = tk.Entry(root, font=font_style)
        self.age_entry.grid(row=1, column=1)
        
        tk.Label(root, text="Enter Weight (kg):", font=font_style, bg="#DFF6FF").grid(row=2, column=0)
        self.weight_entry = tk.Entry(root, font=font_style)
        self.weight_entry.grid(row=2, column=1)
        
        self.create_user_btn = tk.Button(root, text="Create Profile", font=font_style, command=self.create_user, bg="#A0C4FF")
        self.create_user_btn.grid(row=3, column=0, columnspan=2)
        
        self.workout_listbox = tk.Listbox(root, width=60, height=10, font=font_style, bg="#FFD6A5")
        self.workout_listbox.grid(row=4, column=0, columnspan=2)
        self.workout_listbox.bind("<Double-Button-1>", self.edit_workout)
        
        self.add_workout_btn = tk.Button(root, text="Add Workout", font=font_style, command=self.add_workout, state=tk.DISABLED, bg="#FFADAD")
        self.add_workout_btn.grid(row=5, column=0)
        
        self.save_btn = tk.Button(root, text="Save Workouts", font=font_style, command=self.save_workouts, state=tk.DISABLED, bg="#FFC6FF")
    ...
    def add_workout(self, workout=None, index=None):
        ...
        tk.Label(workout_window, text="Date (YYYY-MM-DD):", font=font_style).grid(row=0, column=0)
        date_entry = tk.Entry(workout_window, font=font_style)
        date_entry.grid(row=0, column=1)
        
        tk.Label(workout_window, text="Exercise Type:", font=font_style).grid(row=1, column=0)
        exercise_entry = tk.Entry(workout_window, font=font_style)
        exercise_entry.grid(row=1, column=1)
        
        tk.Label(workout_window, text="Duration (minutes):", font=font_style).grid(row=2, column=0)
        duration_entry = tk.Entry(workout_window, font=font_style)
        duration_entry.grid(row=2, column=1)
        
        tk.Label(workout_window, text="Calories Burned:", font=font_style).grid(row=3, column=0)
        calories_entry = tk.Entry(workout_window, font=font_style)
        ...
        tk.Button(workout_window, text="Save Workout", font=font_style, command=save_workout).grid(row=4, column=0, columnspan=2)
